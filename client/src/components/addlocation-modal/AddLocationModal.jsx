...
const AddLocationModal = () => {
  ...
  return ( 
    <div className="addLocation-component w-full h-screen flex items-center justify-center my-3 bg-no-repeat bg-cover">
      ...
      <form className=" addLocation bg-[#22447e] w-80 h-auto rounded-lg pt-8 pb-8 px-6 flex flex-col items-center shadow-xl mb-4 md:flex md:flex-wrap md:justify-between">
        <div>
